...
!function webpackUniversalModuleDefinition(e, t) {
    ...
    return ( () => {
        ...
        var __webpack_modules__ = [, (e, t, s) => {
            ...
            t.addLinkAttributes = function addLinkAttributes(e, {url: t, target: s, rel: a, enabled: o=!0}={}) {
                (0,
            ...
            class BaseCanvasFactory {
                ...
                create(e, t) {
                    (0,
                    r.unreachable)("Abstract method `create` called.")
                }
                reset(e, t, s) {
                    if (!e.canvas)
            ...
            t.DOMCMapReaderFactory = class DOMCMapReaderFactory extends BaseCMapReaderFactory {
                _fetchData(e, t) {
                    return isFetchSupported() && isValidFetchUrl(e, document.baseURI) ? fetch(e).then((async e => {
                        ...
                        let s;
                        s = this.isCompressed ? new Uint8Array(await e.arrayBuffer()) : (0,
                        r.stringToBytes)(await e.text());
                        return {
                            cMapData: s,
                            compressionType: t
                        }
            ...
            t.DOMSVGFactory = class DOMSVGFactory {
                create(e, t) {
                    (0,
                    r.assert)(e > 0 && t > 0, "Invalid SVG dimensions");
                ...
                createElement(e) {
                    (0,
                    r.assert)("string" == typeof e, "Invalid SVG element type");
        ...
        , (__unused_webpack_module, exports, __w_pdfjs_require__) => {
            ...
            function getDocument(e) {
                ...
                "boolean" != typeof r.disableFontFace && (r.disableFontFace = _api_compatibility.apiCompatibilityParams.disableFontFace || !1);
            ...
            class PDFDocumentProxy {
                ...
                saveDocument() {
                    ...
                    _display_utils.deprecated)("saveDocument no longer accepts any options.");
            ...
            class PDFPageProxy {
                ...
                render({canvasContext: e, viewport: t, intent: s="display", renderInteractiveForms: r=!1, transform: n=null, imageLayer: a=null, canvasFactory: i=null, background: o=null, includeAnnotationStorage: l=!1, optionalContentConfigPromise: c=null}) {
                    var h;
                    if (void 0 !== arguments[0]?.annotationStorage) {
                        (0,
                        _display_utils.deprecated)("render no longer accepts an `annotationStorage` option, please use the `includeAnnotationStorage`-boolean instead.");
            ...
            const InternalRenderTask = function InternalRenderTaskClosure() {
                ...
                return class InternalRenderTask {
                    ...
                    initializeGraphics({transparency: t=!1, optionalContentConfig: s}) {
                        ...
                        this.gfx = new _canvas.CanvasGraphics(r,this.commonObjs,this.objs,this.canvasFactory,i,s);
        ...
        , (e, t, s) => {
            ...
            class BaseFontLoader {
                ...
                get isFontLoadingAPISupported() {
                    return (0,
                    r.shadow)(this, "isFontLoadingAPISupported", !!this._document?.fonts)
                }
            ...
            const o = function CanvasGraphicsClosure() {
                ...
                class CanvasGraphics {
                    ...
                    paintImageMaskXObject(e) {
                        ...
                        i && void 0 === i.compiled && (i.compiled = s <= 1e3 && r <= 1e3 ? function compileType3Glyph(e) {
                    ...
                    paintInlineImageXObject(e) {
                        ...
                        let a, i, o, l = Math.max(Math.hypot(n[0], n[1]), 1), c = Math.max(Math.hypot(n[2], n[3]), 1);
        ...
        , (e, t, s) => {
            ...
            class RadialAxialShadingPattern extends BaseShadingPattern {
                ...
                getPattern(e, t, s) {
                    ...
                    if (s)
                        n.setTransform.apply(n, e.mozCurrentTransform);
                    else {
                    ...
                    let a;
                    "axial" === this._type ? a = n.createLinearGradient(this._p0[0], this._p0[1], this._p1[0], this._p1[1]) : "radial" === this._type && (a = n.createRadialGradient(this._p0[0], this._p0[1], this._r0, this._p1[0], this._p1[1], this._r1));
                    for (const e of this._colorStops)
                        a.addColorStop(e[0], e[1]);
                    n.fillStyle = a;
                    n.fill();
        ...
        , (e, t, s) => {
            ...
            t.MessageHandler = class MessageHandler {
                ...
                _processStreamMessage(e) {
                    ...
                    case c:
                        (0,
                        r.assert)(this.streamControllers[t], "enqueue should have stream controller");
                    ...
                    case l:
                        (0,
                        r.assert)(this.streamControllers[t], "close should have stream controller");
                        if (this.streamControllers[t].isClosed)
                            break;
                    ...
                    case h:
                        (0,
                        r.assert)(this.streamControllers[t], "error should have stream controller");
        ...
        , (e, t, s) => {
            ...
            class LinkAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    e.url ? (0,
                    r.addLinkAttributes)(s, {
                        url: e.url,
                        target: e.newWindow ? r.LinkTarget.BLANK : t.externalLinkTarget,
                        rel: t.externalLinkRel,
                        enabled: t.externalLinkEnabled
                    }) : e.action ? this._bindNamedAction(s, e.action) : e.dest ? this._bindLink(s, e.dest) : e.actions && (e.actions.Action || e.actions["Mouse Up"] || e.actions["Mouse Down"]) && this.enableScripting && this.hasJSActions ? this._bindJSAction(s, e) : this._bindLink(s, "");
                    if (this.quadrilaterals)
                ...
                render() {
                    ...
                    n.addEventListener("change", (function(t) {
                        ...
                        for (const s of document.getElementsByName(r))
                            if (s !== t.target) {
                                s.checked = !1;
                                e.setValue(s.parentNode.getAttribute("data-annotation-id"), {
                                    value: !1
                                })
                            }
                        e.setValue(s, {
                ...
                render() {
                    ...
                    n.addEventListener("change", (function(t) {
                        ...
                        for (const t of document.getElementsByName(r.name))
                            t !== r && e.setValue(t.getAttribute("id"), {
                                value: !1
                            });
                        e.setValue(s, {
                            value: r.checked
            ...
            class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    if (this.enableScripting && this.hasJSActions) {
                        ...
                        this._setEventListeners(s, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"], ["input", "Action"]], (e => e.target.checked))
                    } else
            ...
            t.XfaLayer = class XfaLayer {
                static setupStorage(e, t, s, r) {
                    ...
                    case "input":
                        ...
                        "radio" === s.attributes.type ? e.addEventListener("change", (e => {
                            const {target: s} = e;
                            for (const e of document.getElementsByName(s.name))
                                if (e !== s) {
                                    const t = e.id;
                                    r.setValue(t.split("-")[0], {
                                        value: !1
                                    })
                                }
                            r.setValue(t, {
                ...
                static setAttributes(e, t, s) {
                    ...
                    for (const [t,s] of Object.entries(r))
                        null != s && "fieldId" !== t && ("style" !== t ? "textContent" === t ? e.textContent = s : e.setAttribute(t, s) : Object.assign(e.style, s));
                ...
                static render(e) {
                    ...
                    for (; n.length > 0; ) {
                        ...
                        a.children && a.children.length > 0 ? n.push([a, -1, o]) : a.value && o.appendChild(document.createTextNode(a.value))
                    }
                }
                static update(e) {
                    const t = `matrix(${e.viewport.transform.join(",")})`;
        ...
        ( () => {
              ...
              , c = __w_pdfjs_require__(21);
            {
                ...
                if (e) {
                    ...
                    let r;
                    (0,
                    t.isFetchSupported)() && (r = __w_pdfjs_require__(26).PDFFetchStream);
                    (0,
                    s.setPDFNetworkStreamFactory)((s => r && (0,
                    t.isValidFetchUrl)(s.url) ? new r(s) : new e(s)))
                }
            }
        }
        )();
